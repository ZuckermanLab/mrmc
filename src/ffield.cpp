...
void forcefield::moved_non_tabulated_energy(double eps, int rdie, double cutoff2, int numOfAtoms, ATOMS * atoms, bool * movedatoms, int nb_atom_list_size, atom_nb_entry * nb_atom_list,  double * coords, double * energies)
{
  int i,j,k;
  int ij;
  int ires;
